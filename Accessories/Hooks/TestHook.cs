...
namespace NightmaresMod.Items.Accessories.Hooks
{
	internal class TestHookItem : ModItem
	{
		public override void SetStaticDefaults()
        {
			DisplayName.SetDefault("Test Hook");
		}
		...
		public override void SetDefaults() {
			...
			*/
			...
			item.shoot = mod.ProjectileType("TestHookProjectile");
		}
	}

	internal class TestHookProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
        {
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
			...
			while (distance > 30f && !float.IsNaN(distance))
            {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/Accessories/Hooks/TestHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
					new Rectangle(0, 0, Main.chain30Texture.Width, Main.chain30Texture.Height), drawColor, projRotation,
					new Vector2(Main.chain30Texture.Width * .5f, Main.chain30Texture.Height * 0.5f), 1f, SpriteEffects.None, 0f);
			}
			return true;
		}
	}
