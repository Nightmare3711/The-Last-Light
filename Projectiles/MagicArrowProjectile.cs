...
namespace NightmaresMod.Projectiles
{
	...
	public class MagicArrowProjectile : ModProjectile
	{
		...
		public override Color? GetAlpha(Color lightColor) => new Color(255, 100, 100, 0);
		...
		public override void AI() {
			...
			if (Main.myPlayer == projectile.owner && projectile.ai[0] == 0f)
            {
				...
				else if (projectile.ai[0] == 0f)
                {
					...
					//If the projectile was at the cursor's position, set it to move in the opposite direction from the player.
        ...
        } Not too sure what this does, but I might need it*/
    }
}