...
{
	public class NightmareDresser : ModTile
	{
		public override void SetDefaults() {
			...
			name.SetDefault("Nightmare Dresser");
			AddMapEntry(new Color(200, 200, 200), name);
			dustType = mod.DustType("NightmariumDust");
			disableSmartCursor = true;
			adjTiles = new int[] { TileID.Dressers };
			dresser = "Nightmare Dresser";
			dresserDrop = mod.ItemType("NightmareDresser");
		}
		...
		public override void MouseOverFar(int i, int j) {
			...
			if (chestIndex < 0) {
				...
				if (player.showItemIconText == chest) {
					player.showItemIcon2 = mod.ItemType("NightmareDresser");
